...
var Tooltip = {
  ...
  setPosition() {
    this.autoUpdateCleanup = autoUpdate(this.reference, this.tooltip, () => {
      computePosition2(this.reference, this.tooltip, {
        placement: this.el.dataset.placement,
        strategy: this.el.dataset.strategy,
        middleware: [
          offset2(6),
  ...
  setup() {
    ...
    this.reference = this.tooltip.dataset.reference ? document.querySelector(this.tooltip.dataset.reference) : this.el.previousElementSibling;
